    ...
    <base-header type="success" class="pb-6 pb-8 pt-5 pt-md-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <base-button @click="adminModal = true" class="my-4 float-right bg-custom-pink"><i class="fa fa-plus"></i>&nbsp;Create Admin </base-button>

          <modal :show.sync="adminModal" body-classes="p-0" modal-classes="modal-dialog-centered modal-sm">
            ...
            <card type="secondary" shadow header-classes="bg-white pb-5" body-classes="px-lg-5 py-lg-3" class="border-0">
              <template>
                <form role="form">
                  <base-input alternative class="mb-3" placeholder="Email" addon-left-icon="ni ni-email-83" v-model="newAdmin.email"> </base-input>
                  <base-input alternative type="password" placeholder="Password" addon-left-icon="ni ni-lock-circle-open" v-model="newAdmin.password">
                  </base-input>
                  <base-input alternative type="text" placeholder="Username" addon-left-icon="ni ni-circle-08" v-model="newAdmin.username">
                  </base-input>
                  <base-input alternative type="text" placeholder="Phone Number" addon-left-icon="ni ni-mobile-button" v-model="newAdmin.phone">
                  </base-input>

                  <div class="text-center">
                    <base-button @click="createNewAdmin" type="primary" class="my-4" :disabled="this.isLoading"
